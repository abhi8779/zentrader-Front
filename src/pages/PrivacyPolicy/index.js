  ...
  return (
    <DashboardPage>
      <Card className={classes.privacyCard}>
        ...
        <Typography noWrap>&nbsp;</Typography>
        <Typography variant="subtitle1">
          Asmita Patel Global School Of Trading Private Limited operates the web
          site at Rytt.com (“Site”). We respect the privacy of each user of the
          Site (referred to as “you” or “a user”), whether it’s your first time,
          or if you’ve visited our Site previously. This Privacy Statement gives
          you specific information about how we protect your privacy, how we
          treat the information we collect on the site that identifies an
          individual user (“Personal Information”), and how we use aggregated
          information.
        </Typography>
        <Typography noWrap>&nbsp;</Typography>
        <Typography variant="subtitle1">
        ...
        <Typography noWrap>&nbsp;</Typography>
        <TitleDescription
          title={'Location Of Servers And Transfer Of Information To India'}
          description={
            'The site is hosted By servers In India. If you are located outside of India, your Personal Information will be transferred to India. By submitting your Personal Information, you consent to its transfer to India and to its storage, processing, and use in accordance with this Privacy Statement.'
          }
        />
        <TitleDescription
        ...
        <TitleDescription
          ...
          description={
            ' We collect your Personal Information, and in the case of account opening, background, financial, and demographic information on the Site in order to enhance the services we offer you. Such information may include your name, date of birth, residence and employment addresses, father’s and spouses names, bank account details, scans/copies of document proofs such as PAN, passport, Aadhaar, Broking account details and its credentials etc. We may hold this information indefinitely as required by the law, for the purpose of offering you our services, and for other regulatory and business purposes. We collect Personal Information from you only when you voluntarily submit for purposes including but not limited to a) sales and account opening queries b) account opening c) partnership / association enquiries, and others. We may use the information for purposes including, but not limited to a) identity verification and background checking for account opening b) personalising services offered to you c) keeping you updated of our products and services relevant to you d) information pertaining our services you’ve subscribed to d) for legal and regulatory purposes. Rytt may have the requirement to collect Sensitive Personal Data or Information (“SPDI”) OR Personal Information from you while offering their products and services due to the nature of the products and services being offered. SPDI shall have the meaning in accordance with the Information Technology (Reasonable security practices and procedures and sensitive personal data or Information) Rules, 2011 (“Rules”).'
          }
        />
        <TitleDescription
          title={'Aadhaar User Consent Policy'}
          description={
            '   The act of providing your Aadhaar number to Rytt is voluntary in nature and is only required if you choose to use our services.'
          }
        />
        <TitleDescription
        ...
        <TitleDescription
          ...
          description={
            ' If your Personal Information changes or if you no longer wish to use the Site, you may correct or update your Personal Information or unsubscribe from any industry updates you have requested by modifying or deleting your profile on the Site, writing to customer service at Rytt, sending an email to support@Rytt.com.'
          }
        />
        <TitleDescription
          title={'Children'}
